...
export const SupplierInputs: React.FC = () => {
  ...
  const onChangeNumber = (supplierName: string, month: number, key: MetricKey, raw: string) => {
    const val = raw === "" ? 0 : Number(raw);
    updateSupplierMetric(supplierName, month, key, Number.isFinite(val) ? val : 0);
  };
  ...
  return (
    <section className="gap-6">
      ...
      <div>
        <h2 className="text-lg font-semibold">Data on cooperation with suppliers A and B</h2>
      </div>
